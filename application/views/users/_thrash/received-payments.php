    ...
    <div class="container">
        <div class="col-md-8" id="acc-nav">
            <ul class="nav nav-tabs">
              ...
              <li role="presentation" class="active"><a href="received-payments.php">Received Payments</a></li>
            </ul>
        </div>
        <div class="col-md-4">
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button type="submit" class="btn btn-sm btn-success">Confirm</button> <button type="submit" class="btn btn-sm btn-danger">Report</button><br>If clicked, disable buttons</td>
                        </tr>
                       <p>If the report button is clicked, first show a warning that "it is a crime to report a member who has made payment" then continue to show a notification that the reported member has been removed from the system.</p>
                    </tbody>
                </table>
            </div>
        </div>

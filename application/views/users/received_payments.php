    ...
    <div class="container">
        <div class="col-md-8" id="acc-nav">
            <ul class="nav nav-tabs">
              ...
              <li role="presentation"  class="active"><?php echo anchor('users/received', 'Received Payments');?></li>
            </ul>
        </div>
        <div class="col-md-4">
        </div>
        ...
        <div class="col-md-8" id="views">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                    <?php if( $receive->num_rows() > 0 ): ?>
                            <?php foreach($receive->result() as $row ) :?>
                        <tr>
                            <td><?php echo ucfirst($row->receiver_name); ?></td>
